...
#Usage .spderpfp  Im Not Responsible For Any Ban caused By This
...
@borg.on(admin_cmd(pattern="spiderlogo ?(.*)"))
async def main(event):
    await event.edit("**Starting spiderlogo Profile Pic.") #Owner @spdy_parker
    while True:
        await animepp()
